package org.jsp.employeapp.dao;
...
import org.jsp.employeepp.dto.Employee;
...
public class EmployeeDao {
	...
	public Employee updateEmployee(Employee employee) {
		Employee dbEmployee = s.get(Employee.class, employee.getId()); //fetching employee & storing updating dbEmployee in bdEmployee & returning Updated dbEmployee
		if (dbEmployee != null) {
			Transaction t = s.beginTransaction();
